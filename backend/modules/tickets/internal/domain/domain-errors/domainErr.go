...
var (
	...
	ErrUnknownAssignee    = errors.New("invalid assignee: assignee must be a registered support agent")
	...
	ErrPasswordChangeRequired = errors.New("password change required: set a new password before using the system")
